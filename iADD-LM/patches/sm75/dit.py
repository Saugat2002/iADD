...
except ImportError:  # sm_75 fallback: use torch SDPA
  flash_attn = None
...
def apply_rotary_pos_emb(qkv, cos, sin):
  ...
  # pure-torch fallback: rotary on q and k, identity on v
...
class DDiTBlock(nn.Module):
  ...
  def forward(self, x, rotary_cos_sin, c, seqlens=None):
    ...
    if flash_attn is not None:
      ...
      assert seqlens is None, 'packed sequences need flash_attn'
